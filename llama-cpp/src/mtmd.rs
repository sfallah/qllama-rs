...
pub enum MtmdInputChunkType {
    /// Text input chunk
    Text = llama_cpp_sys::MTMD_INPUT_CHUNK_TYPE_TEXT as u32,
    /// Image input chunk
    Image = llama_cpp_sys::MTMD_INPUT_CHUNK_TYPE_IMAGE as u32,
    /// Audio input chunk
    Audio = llama_cpp_sys::MTMD_INPUT_CHUNK_TYPE_AUDIO as u32,
}
