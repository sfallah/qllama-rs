...
impl ParamOverrideValue {
    pub(crate) fn tag(&self) -> qllama_sys::llama_model_kv_override_type {
        match self {
            ParamOverrideValue::Bool(_) => qllama_sys::LLAMA_KV_OVERRIDE_TYPE_BOOL,
            ParamOverrideValue::Float(_) => qllama_sys::LLAMA_KV_OVERRIDE_TYPE_FLOAT,
            ParamOverrideValue::Int(_) => qllama_sys::LLAMA_KV_OVERRIDE_TYPE_INT,
            ParamOverrideValue::Str(_) => qllama_sys::LLAMA_KV_OVERRIDE_TYPE_STR,
        }
    }

    pub(crate) fn value(&self) -> qllama_sys::llama_model_kv_override__bindgen_ty_1 {
        match self {
            ParamOverrideValue::Bool(value) => {
                qllama_sys::llama_model_kv_override__bindgen_ty_1 { val_bool: *value }
            }
            ParamOverrideValue::Float(value) => {
                qllama_sys::llama_model_kv_override__bindgen_ty_1 { val_f64: *value }
            }
            ParamOverrideValue::Int(value) => {
                qllama_sys::llama_model_kv_override__bindgen_ty_1 { val_i64: *value }
            }
            ParamOverrideValue::Str(c_string) => {
                qllama_sys::llama_model_kv_override__bindgen_ty_1 { val_str: *c_string }
            }
        }
    }
}

impl From<&qllama_sys::llama_model_kv_override> for ParamOverrideValue {
    fn from(
        qllama_sys::llama_model_kv_override {
            key: _,
            tag,
            __bindgen_anon_1,
        }: &qllama_sys::llama_model_kv_override,
