...
impl LlamaContextParams {
    ...
    ///
    /// ```rust
    /// # use qllama::context::params::{LlamaContextParams, LlamaAttentionType};
    /// let params = LlamaContextParams::default()
    ...
    pub fn with_flash_attention_policy(
        mut self,
        policy: qllama_sys::llama_flash_attn_type,
    ) -> Self {
    ...
    #[must_use]
    pub fn flash_attention_policy(&self) -> qllama_sys::llama_flash_attn_type {
    ...
    ///
    /// ```rust
    /// # use qllama::context::params::{LlamaContextParams, KvCacheType};
