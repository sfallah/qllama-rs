...
use llama_cpp_rs_bench::{batch_decode_rerank, hf_tokenize, init_backend, init_model, init_reranker_context, init_splitter, llama_cpp_tokenize, process_batch, process_single, to_llama_tokens};
use std::fs;
    ...
    c.bench_function("reranker_benchmark", |b| {
        b.iter(|| {
            let tokens_lines_list = prompt_lines
                ...
                .with_context(|| format!("failed to tokenize {:?}", prompt_lines)).unwrap();
